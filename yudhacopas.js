...
const starts = async (dha = new WAConnection()) => {
	...
	console.log(color(figlet.textSync('Herman Bot', {
		font: 'Standard',
...
const spinner = { 
  ...
  "frames": [
	...
	//connect
	dha.on('open', () => {
		console.log(color('[ Herman Chanel ]', 'yellow'), color('BOT SUDAH AKTIF  SELAMAT MENGGUNAKAN'));
	})
